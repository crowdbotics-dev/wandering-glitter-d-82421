...
## Project Structure
    ...
    ├── wandering_glitter_d_82421  # Django project configurations
...
1. Clone this repo and `cd wandering_glitter_d_82421`
...
2. Clone this repo and `cd wandering_glitter_d_82421`
